<template>
	<div class="pricebox">
		...
		<div class="paybox">
			<span>应付总额：</span>
			<span id="totalpay">{{price}}.00</span>
		</div>
		<div class="paymode">
			<img src="@/assets/paypic1.png" id="vxpay1" />
			<img src="@/assets/paypic2.png" id="zfbpay1" />
		</div>
		...
		methods: {
			...
			payfor() {
				if (this.orderInfo) {
					...
					this.$axios.post("http://localhost:81/addtoorder", formdata,config)
						.then(() => {
							this.$router.push({
								path: "/success"
							})
